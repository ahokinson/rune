...
[rune](README.md) / MeshEntity3D

# Class: MeshEntity3D

Defined in: scene/meshEntity3d.ts:42

An [Entity3D](Class.Entity3D.md) that draws an indexed triangle mesh through the renderMesh
rasterizer.
...
it to a [Scene3D](Class.Scene3D.md) created with `subpixel: true`. The mesh, floor, and any
...
```ts
new MeshEntity3D(options): MeshEntity3D;
```

Defined in: scene/meshEntity3d.ts:62
...
Defined in: scene/meshEntity3d.ts:50
...
Defined in: scene/meshEntity3d.ts:54
...
Defined in: scene/meshEntity3d.ts:44
...
Defined in: scene/meshEntity3d.ts:52
...
Defined in: scene/meshEntity3d.ts:46
...
Defined in: scene/meshEntity3d.ts:48
...
Defined in: scene/meshEntity3d.ts:78
