...
[rune](README.md) / Particles3D

# Class: Particles3D

Defined in: fx/particles3d.ts:85
...
```ts
new Particles3D(options): Particles3D;
```

Defined in: fx/particles3d.ts:108

#### Parameters

##### options

[`Particles3DOptions`](Interface.Particles3DOptions.md)
...
Defined in: fx/particles3d.ts:91
...
Defined in: fx/particles3d.ts:93
...
Defined in: fx/particles3d.ts:99
...
Defined in: fx/particles3d.ts:95
...
Defined in: fx/particles3d.ts:97
...
Defined in: fx/particles3d.ts:87
...
Defined in: fx/particles3d.ts:101
...
Defined in: fx/particles3d.ts:89
...
Defined in: fx/particles3d.ts:203
...
Defined in: fx/particles3d.ts:187
...
3D draw context (camera, viewport, canvas, depth buffer).
...
Defined in: fx/particles3d.ts:138
...
Defined in: fx/particles3d.ts:163
