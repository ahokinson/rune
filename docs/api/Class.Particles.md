...
[rune](README.md) / Particles

# Class: Particles

Defined in: fx/particles.ts:69
...
```ts
new Particles(options): Particles;
```

Defined in: fx/particles.ts:102

#### Parameters

##### options

[`ParticlesOptions`](Interface.ParticlesOptions.md)
...
Defined in: fx/particles.ts:255
...
Defined in: fx/particles.ts:230
...
Optional camera for orthographic projection.
...
Defined in: fx/particles.ts:138
...
Defined in: fx/particles.ts:165
