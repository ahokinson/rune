...
[rune](README.md) / PointCloud3D

# Class: PointCloud3D

Defined in: geom/geometry3d.ts:52
...
Defined in: geom/geometry3d.ts:66
...
[`PointStyle`](Interface.PointStyle.md)

Per-point draw callback.

##### options?

[`PointCloud3DOptions`](Interface.PointCloud3DOptions.md) = `{}`

zIndex and depth cull.
...
Defined in: geom/geometry3d.ts:58
...
Defined in: geom/geometry3d.ts:54
...
Defined in: geom/geometry3d.ts:56
...
Defined in: geom/geometry3d.ts:78

Project each point, cull by depth, and draw the survivors via [PointCloud3D.style](#style).
...
3D draw context (camera, viewport, depth buffer, canvas).
