...
[rune](README.md) / Polyline3D

# Class: Polyline3D

Defined in: geom/geometry3d.ts:127
...
```ts
new Polyline3D(style, options?): Polyline3D;
```

Defined in: geom/geometry3d.ts:145

#### Parameters

##### style

[`PolylineStyle`](Interface.PolylineStyle.md)

Per-cell draw callback.

##### options?

[`Polyline3DOptions`](Interface.Polyline3DOptions.md) = `{}`
...
Defined in: geom/geometry3d.ts:131
...
Defined in: geom/geometry3d.ts:135

Index passed to [PolylineStyle.drawSegment](Interface.PolylineStyle.md#drawsegment) so pooled polylines differ.
...
Defined in: geom/geometry3d.ts:133
...
Defined in: geom/geometry3d.ts:129
...
Defined in: geom/geometry3d.ts:156
