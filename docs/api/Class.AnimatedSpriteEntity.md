...
[rune](README.md) / AnimatedSpriteEntity

# Class: AnimatedSpriteEntity

Defined in: scene/animatedSpriteEntity.ts:35

An [Entity2D](Class.Entity2D.md) backed by an [AnimatedSprite](Class.AnimatedSprite.md).
...
```ts
new AnimatedSpriteEntity(options): AnimatedSpriteEntity;
```

Defined in: scene/animatedSpriteEntity.ts:43
...
Construction options. `size` defaults to the current frame's
  dimensions.
...
Defined in: scene/animatedSpriteEntity.ts:37
...
Defined in: scene/animatedSpriteEntity.ts:67
...
Defined in: scene/animatedSpriteEntity.ts:57
